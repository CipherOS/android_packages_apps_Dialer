 ...
 */
package com.cipheros.dialer.calllog.ui;
...
import com.cipheros.dialer.calllog.RefreshAnnotatedCallLogReceiver;
import com.cipheros.dialer.calllog.database.CallLogDatabaseComponent;
import com.cipheros.dialer.calllog.database.Coalescer;
import com.cipheros.dialer.calllog.model.CoalescedRow;
...
public final class NewCallLogFragment extends Fragment implements LoaderCallbacks<Cursor> {
  ...
  private void configureEmptyContentView() {
    ...
    emptyContentView.setActionLabel(com.cipheros.dialer.widget.R.string.permission_single_turn_on);
