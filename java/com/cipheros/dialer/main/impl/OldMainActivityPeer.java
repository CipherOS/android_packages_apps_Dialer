...
package com.cipheros.dialer.main.impl;
...
import com.cipheros.dialer.animation.AnimUtils;
import com.cipheros.dialer.app.MainComponent;
import com.cipheros.dialer.app.calllog.CallLogAdapter;
import com.cipheros.dialer.app.calllog.CallLogFragment;
import com.cipheros.dialer.app.calllog.CallLogFragment.CallLogFragmentListener;
import com.cipheros.dialer.app.calllog.CallLogNotificationsService;
import com.cipheros.dialer.app.calllog.IntentProvider;
import com.cipheros.dialer.app.calllog.VisualVoicemailCallLogFragment;
import com.cipheros.dialer.app.list.DragDropController;
import com.cipheros.dialer.app.list.OldSpeedDialFragment;
import com.cipheros.dialer.app.list.OnDragDropListener;
import com.cipheros.dialer.app.list.OnListFragmentScrolledListener;
import com.cipheros.dialer.app.list.PhoneFavoriteSquareTileView;
import com.cipheros.dialer.app.list.RemoveView;
import com.cipheros.dialer.callcomposer.CallComposerActivity;
import com.cipheros.dialer.calldetails.OldCallDetailsActivity;
import com.cipheros.dialer.callintent.CallIntentBuilder;
import com.cipheros.dialer.callintent.CallSpecificAppData;
import com.cipheros.dialer.calllog.CallLogComponent;
import com.cipheros.dialer.calllog.config.CallLogConfigComponent;
import com.cipheros.dialer.calllog.ui.NewCallLogFragment;
import com.cipheros.dialer.common.FragmentUtils.FragmentUtilListener;
import com.cipheros.dialer.common.LogUtil;
import com.cipheros.dialer.common.concurrent.DefaultFutureCallback;
import com.cipheros.dialer.common.concurrent.DialerExecutorComponent;
import com.cipheros.dialer.common.concurrent.ThreadUtil;
import com.cipheros.dialer.common.concurrent.UiListener;
import com.cipheros.dialer.configprovider.ConfigProviderComponent;
import com.cipheros.dialer.constants.ActivityRequestCodes;
import com.cipheros.dialer.contactsfragment.ContactsFragment;
import com.cipheros.dialer.contactsfragment.ContactsFragment.Header;
import com.cipheros.dialer.contactsfragment.ContactsFragment.OnContactSelectedListener;
import com.cipheros.dialer.database.CallLogQueryHandler;
import com.cipheros.dialer.database.Database;
import com.cipheros.dialer.dialpadview.DialpadFragment;
import com.cipheros.dialer.dialpadview.DialpadFragment.DialpadListener;
import com.cipheros.dialer.dialpadview.DialpadFragment.LastOutgoingCallCallback;
import com.cipheros.dialer.dialpadview.DialpadFragment.OnDialpadQueryChangedListener;
import com.cipheros.dialer.duo.DuoComponent;
import com.cipheros.dialer.i18n.LocaleUtils;
import com.cipheros.dialer.interactions.PhoneNumberInteraction;
import com.cipheros.dialer.logging.DialerImpression;
import com.cipheros.dialer.logging.Logger;
import com.cipheros.dialer.logging.ScreenEvent;
import com.cipheros.dialer.main.MainActivityPeer;
import com.cipheros.dialer.main.impl.bottomnav.BottomNavBar;
import com.cipheros.dialer.main.impl.bottomnav.BottomNavBar.OnBottomNavTabSelectedListener;
import com.cipheros.dialer.main.impl.bottomnav.BottomNavBar.TabIndex;
import com.cipheros.dialer.main.impl.bottomnav.MissedCallCountObserver;
import com.cipheros.dialer.main.impl.toolbar.MainToolbar;
import com.cipheros.dialer.metrics.Metrics;
import com.cipheros.dialer.metrics.MetricsComponent;
import com.cipheros.dialer.postcall.PostCall;
import com.cipheros.dialer.precall.PreCall;
import com.cipheros.dialer.promotion.Promotion;
import com.cipheros.dialer.promotion.Promotion.PromotionType;
import com.cipheros.dialer.promotion.PromotionComponent;
import com.cipheros.dialer.searchfragment.list.NewSearchFragment.SearchFragmentListener;
import com.cipheros.dialer.smartdial.util.SmartDialPrefix;
import com.cipheros.dialer.speeddial.SpeedDialFragment;
import com.cipheros.dialer.storage.StorageComponent;
import com.cipheros.dialer.telecom.TelecomUtil;
import com.cipheros.dialer.theme.base.Theme;
import com.cipheros.dialer.theme.base.ThemeComponent;
import com.cipheros.dialer.util.DialerUtils;
import com.cipheros.dialer.util.PermissionsUtil;
import com.cipheros.dialer.util.TransactionSafeActivity;
import com.cipheros.dialer.voicemail.listui.NewVoicemailFragment;
import com.cipheros.dialer.voicemail.listui.error.VoicemailStatusCorruptionHandler;
import com.cipheros.dialer.voicemail.listui.error.VoicemailStatusCorruptionHandler.Source;
import com.cipheros.dialer.voicemailstatus.VisualVoicemailEnabledChecker;
import com.cipheros.dialer.voicemailstatus.VoicemailStatusHelper;
