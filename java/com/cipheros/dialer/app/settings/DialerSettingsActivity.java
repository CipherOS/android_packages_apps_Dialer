 ...
 */
package com.cipheros.dialer.app.settings;
...
import com.cipheros.dialer.about.AboutPhoneFragment;
...
import com.cipheros.dialer.lookup.LookupSettingsFragment;
import com.cipheros.dialer.proguard.UsedByReflection;
import com.cipheros.dialer.util.PermissionsUtil;
import com.cipheros.dialer.voicemail.settings.VoicemailSettingsFragment;
  ...
  public void onBuildHeaders(List<Header> target) {
    ...
    if (isAssistedDialingEnabled) {
      ...
      assistedDialingSettingsHeader.titleRes =
          com.cipheros.dialer.assisteddialing.ui.R.string.assisted_dialing_setting_title;
      assistedDialingSettingsHeader.intent =
          new Intent("com.cipheros.dialer.app.settings.SHOW_ASSISTED_DIALING_SETTINGS");
