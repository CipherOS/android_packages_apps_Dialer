...
import com.cipheros.dialer.app.calllog.CallLogAdapter.OnActionModeStateChangedListener;
import com.cipheros.dialer.app.calllog.calllogcache.CallLogCache;
import com.cipheros.dialer.app.voicemail.VoicemailPlaybackLayout;
import com.cipheros.dialer.app.voicemail.VoicemailPlaybackPresenter;
import com.cipheros.dialer.blocking.BlockedNumbersMigrator;
import com.cipheros.dialer.blocking.FilteredNumberCompat;
import com.cipheros.dialer.blocking.FilteredNumbersUtil;
...
import com.cipheros.dialer.clipboard.ClipboardUtils;
...
import com.cipheros.dialer.contactphoto.ContactPhotoManager;
import com.cipheros.dialer.dialercontact.DialerContact;
import com.cipheros.dialer.dialercontact.SimDetails;
import com.cipheros.dialer.duo.Duo;
import com.cipheros.dialer.duo.DuoComponent;
import com.cipheros.dialer.lettertile.LetterTileDrawable;
import com.cipheros.dialer.lettertile.LetterTileDrawable.ContactType;
...
import com.cipheros.dialer.phonenumbercache.CachedNumberLookupService;
import com.cipheros.dialer.phonenumbercache.ContactInfo;
import com.cipheros.dialer.phonenumbercache.PhoneNumberCache;
import com.cipheros.dialer.phonenumberutil.PhoneNumberHelper;
import com.cipheros.dialer.telecom.TelecomUtil;
import com.cipheros.dialer.util.CallUtil;
import com.cipheros.dialer.util.DialerUtils;
import com.cipheros.dialer.util.UriUtils;
