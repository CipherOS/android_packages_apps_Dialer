...
import com.cipheros.dialer.callstats.CallStatsFragment;
import com.cipheros.dialer.callstats.DoubleDatePickerDialog;
...
public class CallLogActivity extends TransactionSafeActivity implements
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    ...
    if (item.getItemId() == android.R.id.home) {
      ...
      final Intent intent = new Intent("com.cipheros.dialer.main.impl.MAIN");
