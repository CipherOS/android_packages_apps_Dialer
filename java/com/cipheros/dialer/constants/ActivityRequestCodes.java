...
package com.cipheros.dialer.constants;
...
public final class ActivityRequestCodes {
  ...
  /** Request code for {@link com.cipheros.dialer.callcomposer.CallComposerActivity} intent. */
  public static final int DIALTACTS_CALL_COMPOSER = 2;

  /** Request code for {@link com.cipheros.dialer.duo.Duo#getCallIntent(String)}. */
  public static final int DIALTACTS_DUO = 3;

  /** Request code for {@link com.cipheros.dialer.calldetails.OldCallDetailsActivity} intent. */
  public static final int DIALTACTS_CALL_DETAILS = 4;

  /**
   * Request code for {@link com.cipheros.dialer.speeddial.SpeedDialFragment} contact picker intent.
   */
