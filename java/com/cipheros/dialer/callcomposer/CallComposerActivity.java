...
package com.cipheros.dialer.callcomposer;
...
import com.cipheros.dialer.callcomposer.CallComposerFragment.CallComposerListener;
...
import com.cipheros.dialer.common.concurrent.DialerExecutor;
...
import com.cipheros.dialer.constants.Constants;
...
import com.cipheros.dialer.enrichedcall.Session.State;
import com.cipheros.dialer.enrichedcall.extensions.StateExtension;
import com.cipheros.dialer.logging.DialerImpression;
import com.cipheros.dialer.logging.Logger;
import com.cipheros.dialer.multimedia.MultimediaData;
import com.cipheros.dialer.precall.PreCall;
import com.cipheros.dialer.protos.ProtoParsers;
...
import com.cipheros.dialer.widget.BidiTextView;
import com.cipheros.dialer.widget.DialerToolbar;
import com.cipheros.dialer.widget.LockableViewPager;
    ...
    if (!TextUtils.isEmpty(contact.getDisplayNumber())) {
      ...
      String secondaryInfo =
          TextUtils.isEmpty(contact.getNumberLabel())
              ? contact.getDisplayNumber()
              : getString(
                  com.cipheros.dialer.contacts.resources.R.string.call_subject_type_and_number,
                  contact.getNumberLabel(),
                  contact.getDisplayNumber());
