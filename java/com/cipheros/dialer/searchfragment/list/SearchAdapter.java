...
import com.cipheros.dialer.searchfragment.cp2.SearchContactViewHolder;
import com.cipheros.dialer.searchfragment.directories.DirectoryContactViewHolder;
import com.cipheros.dialer.searchfragment.list.SearchCursorManager.RowType;
import com.cipheros.dialer.searchfragment.nearbyplaces.NearbyPlaceViewHolder;
...
public final class SearchAdapter extends RecyclerView.Adapter<ViewHolder> {
  ...
  private static class LocationPermissionViewHolder extends RecyclerView.ViewHolder {
    ...
    LocationPermissionViewHolder(
      ...
      itemView
          .findViewById(
              com.cipheros.dialer.searchfragment.nearbyplaces.R.id.location_permission_allow)
          .setOnClickListener(allowClickListener);
      itemView
          .findViewById(
              com.cipheros.dialer.searchfragment.nearbyplaces.R.id.location_permission_dismiss)
