...
package com.cipheros.dialer.blocking;
...
import com.cipheros.dialer.database.FilteredNumberContract.FilteredNumber;
import com.cipheros.dialer.database.FilteredNumberContract.FilteredNumberColumns;
import com.cipheros.dialer.database.FilteredNumberContract.FilteredNumberSources;
import com.cipheros.dialer.database.FilteredNumberContract.FilteredNumberTypes;
 ...
 * com.cipheros.dialer.database.FilteredNumberContract} and using {@link
...
public class FilteredNumberCompat {
  ...
  public static Intent createManageBlockedNumbersIntent(Context context) {
    ...
    Intent intent = new Intent("com.cipheros.dialer.action.BLOCKED_NUMBERS_SETTINGS");
