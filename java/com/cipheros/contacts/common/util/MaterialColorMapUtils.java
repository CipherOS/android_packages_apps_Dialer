...
public class MaterialColorMapUtils {
  ...
  public MaterialColorMapUtils(Resources resources) {
    sPrimaryColors =
        resources.obtainTypedArray(com.cipheros.dialer.lettertile.R.array.letter_tile_colors);
    sSecondaryColors =
        resources.obtainTypedArray(
            com.cipheros.dialer.contacts.resources.R.array.letter_tile_colors_dark);
  }
