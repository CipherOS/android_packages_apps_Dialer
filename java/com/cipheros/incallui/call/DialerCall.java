...
import com.cipheros.dialer.assisteddialing.ConcreteCreator;
import com.cipheros.dialer.assisteddialing.TransformationInfo;
import com.cipheros.dialer.blocking.FilteredNumbersUtil;
import com.cipheros.dialer.callintent.CallInitiationType;
import com.cipheros.dialer.callintent.CallIntentParser;
...
import com.cipheros.dialer.compat.telephony.TelephonyManagerCompat;
...
import com.cipheros.dialer.enrichedcall.EnrichedCallManager.CapabilitiesListener;
import com.cipheros.dialer.enrichedcall.EnrichedCallManager.Filter;
import com.cipheros.dialer.enrichedcall.EnrichedCallManager.StateChangedListener;
import com.cipheros.dialer.enrichedcall.Session;
import com.cipheros.dialer.location.GeoUtil;
import com.cipheros.dialer.logging.ContactLookupResult;
import com.cipheros.dialer.logging.ContactLookupResult.Type;
import com.cipheros.dialer.logging.DialerImpression;
import com.cipheros.dialer.logging.Logger;
import com.cipheros.dialer.preferredsim.PreferredAccountRecorder;
import com.cipheros.dialer.rtt.RttTranscript;
import com.cipheros.dialer.rtt.RttTranscriptUtil;
import com.cipheros.dialer.spam.status.SpamStatus;
import com.cipheros.dialer.telecom.TelecomCallUtil;
import com.cipheros.dialer.telecom.TelecomUtil;
import com.cipheros.dialer.theme.common.R;
import com.cipheros.dialer.time.Clock;
...
public class DialerCall implements VideoTechListener, StateChangedListener, CapabilitiesListener {
  ...
  private com.cipheros.dialer.logging.VideoTech.Type selectedAvailableVideoTechType =
      com.cipheros.dialer.logging.VideoTech.Type.NONE;
  ...
  public VideoTech getVideoTech() {
    if (videoTech == null) {
      ...
      if (selectedAvailableVideoTechType == com.cipheros.dialer.logging.VideoTech.Type.NONE) {
  ...
  public com.cipheros.dialer.logging.VideoTech.Type getSelectedAvailableVideoTechType() {
